...
const Hero = ({ children }) => {
    return (
        <div className='flex flex-grow w-full bg-home-banner bg-no-repeat bg-center bg-cover items-center justify-center relative after:bg-black after:z-10 after:h-full after:w-full after:flex after:bg-opacity-70'>
                    ...
                    <div className="flex w-full">
                        <div className="flex flex-col w-full h-fit my-auto gap-10">
                            ...
                            <div className="flex w-full items-center justify-center lg:justify-start flex-col gap-2">
                                ...
                                <p className='flex md:hidden w-full text-center items-center justify-center lg:text-left text-white mx-auto'>Enter a world where tales defy time. </p>
                                <p className='hidden md:flex w-full text-center lg:text-left text-white mx-auto'>Enter a world where tales defy time. Explore cinema's wonders—from classics to modern gems. Discover magic, fuel your imagination, and embark on an unforgettable silver screen adventure.</p>
                            </div>
